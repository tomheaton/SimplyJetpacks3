...
public class ItemJetpackOld extends ArmorItem {
    ...
    @SuppressWarnings("rawtypes")
    public ItemJetpackOld(String name, IArmorMaterial material, EquipmentSlotType slot, Item.Properties properties, BiFunction<BipedModel, EquipmentSlotType, BipedModel<?>> armorApplier, ResourceLocation armorTexture) {
