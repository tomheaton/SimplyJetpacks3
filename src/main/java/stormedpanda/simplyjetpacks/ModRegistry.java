...
public class ModRegistry {
	...
	public static void registerItems(final RegistryEvent.Register<Item> event) {
		event.getRegistry().registerAll (
				...
				ItemList.jetpack_iron_armored = new ItemJetpack("jetpack_iron_armored", ListArmorMaterial.JETPACK, EquipmentSlotType.CHEST, new Item.Properties().group(tabSimplyJetpacks), new ModelJetpack()::applyData, new ResourceLocation("simplyjetpacks:textures/armor/jetpack_iron_armored.png")).setRegistryName(location("jetpack_iron_armored")),
				...
				ItemList.jetpack_diamond_armored = new ItemJetpack("jetpack_diamond_armored", ListArmorMaterial.JETPACK, EquipmentSlotType.CHEST, new Item.Properties().group(tabSimplyJetpacks), new ModelJetpack()::applyData, new ResourceLocation("simplyjetpacks:textures/armor/jetpack_diamond_armored.png")).setRegistryName(location("jetpack_diamond_armored")),
				...
				ItemList.jetpack_netherite_armored = new ItemJetpack("jetpack_netherite_armored", ListArmorMaterial.JETPACK, EquipmentSlotType.CHEST, new Item.Properties().group(tabSimplyJetpacks), new ModelJetpack()::applyData, new ResourceLocation("simplyjetpacks:textures/armor/jetpack_netherite_armored.png")).setRegistryName(location("jetpack_netherite_armored")),
				...
				ItemList.jetpack_creative_armored = new ItemJetpack("jetpack_creative_armored", ListArmorMaterial.JETPACK, EquipmentSlotType.CHEST, new Item.Properties().group(tabSimplyJetpacks), new ModelJetpack()::applyData, new ResourceLocation("simplyjetpacks:textures/armor/jetpack_creative_armored.png")).setRegistryName(location("jetpack_creative_armored")),
				...
				ItemList.jetpack_test_armored = new ItemJetpack("jetpack_test_armored", ListArmorMaterial.JETPACK, EquipmentSlotType.CHEST, new Item.Properties().group(tabSimplyJetpacks), new ModelJetpack()::applyData, new ResourceLocation("simplyjetpacks:textures/armor/jetpack_test_armored.png")).setRegistryName(location("jetpack_test_armored"))
		);
