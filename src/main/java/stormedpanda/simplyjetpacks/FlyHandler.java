...
public class FlyHandler {
    ...
    public static boolean isHoldingForwards(PlayerEntity player) {
        SimplyJetpacks.LOGGER.info("both: " + (HOLDING_FORWARDS.containsKey(player) && HOLDING_FORWARDS.get(player)));
        SimplyJetpacks.LOGGER.info(HOLDING_FORWARDS.containsKey(player));
        SimplyJetpacks.LOGGER.info(HOLDING_FORWARDS.get(player));
