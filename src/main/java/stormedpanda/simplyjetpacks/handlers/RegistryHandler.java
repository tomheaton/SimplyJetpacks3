...
public class RegistryHandler {
    ...
    public static final RegistryObject<Item> JETPACK_VANILLA2 = ITEMS.register("jetpack_vanilla2", () ->
            new JetpackItem(JetpackType.VANILLA2));
    public static final RegistryObject<Item> JETPACK_VANILLA2_ARMORED = ITEMS.register("jetpack_vanilla2_armored", () ->
            new JetpackItem(JetpackType.VANILLA2_ARMORED));
    public static final RegistryObject<Item> JETPACK_VANILLA3 = ITEMS.register("jetpack_vanilla3", () ->
            new JetpackItem(JetpackType.VANILLA3));
    public static final RegistryObject<Item> JETPACK_VANILLA3_ARMORED = ITEMS.register("jetpack_vanilla3_armored", () ->
            new JetpackItem(JetpackType.VANILLA3_ARMORED));
    public static final RegistryObject<Item> JETPACK_VANILLA4 = ITEMS.register("jetpack_vanilla4", () ->
            new JetpackItem(JetpackType.VANILLA4));
    public static final RegistryObject<Item> JETPACK_VANILLA4_ARMORED = ITEMS.register("jetpack_vanilla4_armored", () ->
    ...
    public static final RegistryObject<Item> JETPACK_IE1_ARMORED = ITEMS.register("jetpack_ie1_armored", () ->
            new JetpackItem(JetpackType.IE1_ARMORED));
    public static final RegistryObject<Item> JETPACK_IE2 = ITEMS.register("jetpack_ie2", () ->
            new JetpackItem(JetpackType.IE2));
    public static final RegistryObject<Item> JETPACK_IE2_ARMORED = ITEMS.register("jetpack_ie2_armored", () ->
            new JetpackItem(JetpackType.IE2_ARMORED));
    public static final RegistryObject<Item> JETPACK_IE3 = ITEMS.register("jetpack_ie3", () ->
            new JetpackItem(JetpackType.IE3));
    public static final RegistryObject<Item> JETPACK_IE3_ARMORED = ITEMS.register("jetpack_ie3_armored", () ->
    ...
    public static final RegistryObject<Item> JETPACK_MEK1_ARMORED = ITEMS.register("jetpack_mek1_armored", () ->
            new JetpackItem(JetpackType.MEK1_ARMORED));
    public static final RegistryObject<Item> JETPACK_MEK2 = ITEMS.register("jetpack_mek2", () ->
            new JetpackItem(JetpackType.MEK2));
    public static final RegistryObject<Item> JETPACK_MEK2_ARMORED = ITEMS.register("jetpack_mek2_armored", () ->
            new JetpackItem(JetpackType.MEK2_ARMORED));
    public static final RegistryObject<Item> JETPACK_MEK3 = ITEMS.register("jetpack_mek3", () ->
            new JetpackItem(JetpackType.MEK3));
    public static final RegistryObject<Item> JETPACK_MEK3_ARMORED = ITEMS.register("jetpack_mek3_armored", () ->
            new JetpackItem(JetpackType.MEK3_ARMORED));
    public static final RegistryObject<Item> JETPACK_MEK4 = ITEMS.register("jetpack_mek4", () ->
            new JetpackItem(JetpackType.MEK4));
    public static final RegistryObject<Item> JETPACK_MEK4_ARMORED = ITEMS.register("jetpack_mek4_armored", () ->
