...
public class TestModelJetpack extends BipedModel<PlayerEntity> {
    ...
    public BipedModel<PlayerEntity> applyData(BipedModel defaultArmor, EquipmentSlotType slotType) {
